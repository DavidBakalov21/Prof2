        ...
        try {
            switch (entranceChaoice) {
                ...
                case Constants.REGISTER:
                    ...
                    if (!username.equals("") && !passwordRegister.equals("") && !emailRegister.equals("")
                            && (isAdmin.equals("true") || isAdmin.equals("false"))) {
                        returnClient = db.register(username, passwordRegister, emailRegister,
                                Boolean.parseBoolean(isAdmin), paymentMethod);
                    } else {
